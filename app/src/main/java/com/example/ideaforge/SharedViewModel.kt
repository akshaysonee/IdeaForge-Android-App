...
class SharedViewModel : ViewModel() {
    ...
    // LiveData for sending notifications to other fragments
    val ideaNotification = MutableLiveData<String>()
    ...
    fun sendIdeaNotification(message: String) {
        ideaNotification.value = message
    }
    ...
    fun clearData() {
        ...
        ideaNotification.value = ""  // Optional: clear notification
    }
}
